...
void game_system_init() {
    ...
    data_world_system(game_update_position, EcsOnLoad, hitbox, [in] position);
    data_world_system(game_check_health, EcsPostLoad, hp, npc || enemy);
    data_world_system(game_handle_atk_hit, EcsPostLoad, item_prop, hit, [out] :*);
    data_world_system(game_clean_atks, EcsPreUpdate, hitbox, item_prop, atk_tag, [out] :*);
    data_world_system(game_check_atk_prep, EcsOnUpdate, item_prop, physics_constructor, tick, position, [out] :*);
...
void game_render(double dt) {
    ...
    data_iter_t it = data_world_query_iter(render_query);
